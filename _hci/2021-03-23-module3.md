...
<div class="slideshow-container">
  ...
  <div class="mySlides5">
    <div class="numbertext">1 / 5</div>
    <img src="/images/DesmondAdonleMod3/1.jpg" style="width:100%">
    <div class="text">Student Quiz</div>
  </div>

  <div class="mySlides5">
    <div class="numbertext">2 / 5</div>
    <img src="/images/DesmondAdonleMod3/2.jpg" style="width:100%">
    <div class="text">Instructor's View</div>
  </div>

  <div class="mySlides5">
    <div class="numbertext">3 / 5</div>
    <img src="/images/DesmondAdonleMod3/3.jpg" style="width:100%">
    <div class="text">Student's Quiz Results</div>
  </div>
  
  <div class="mySlides5">
    <div class="numbertext">4 / 5</div>
    <img src="/images/DesmondAdonleMod3/4.jpg" style="width:100%">
    <div class="text">Student's Question about  Result</div>
  </div>
  
  <div class="mySlides5">
    <div class="numbertext">5 / 5</div>
    <img src="/images/DesmondAdonleMod3/5.jpg" style="width:100%">
